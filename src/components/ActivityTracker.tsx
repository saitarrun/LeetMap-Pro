...
function getGitHubCellColor(count: number, isFuture: boolean, isCurrentYear: boolean): string {
  ...
  if (isFuture) {
    return 'bg-[#ebedf0]/40 dark:bg-[#161b22]/40 border border-black/5 dark:border-white/5 opacity-40 cursor-default';
  }
  if (count === 0) {
    return 'bg-[#ebedf0] dark:bg-[#161b22] border border-black/15 dark:border-white/10 hover:border-black/40 dark:hover:border-white/30';
  }
  if (count === 1) {
    return 'bg-[#9be9a8] dark:bg-[#0e4429] border border-[#7bc96f] dark:border-[#006d32] hover:opacity-90';
  }
  if (count <= 3) {
    return 'bg-[#40c463] dark:bg-[#006d32] border border-[#30a14e] dark:border-[#26a641] hover:opacity-90';
  }
  if (count <= 6) {
    return 'bg-[#30a14e] dark:bg-[#26a641] border border-[#216e39] dark:border-[#39d353] hover:opacity-90';
  }
  return 'bg-[#216e39] dark:bg-[#39d353] border border-[#195229] dark:border-[#56e36d] hover:opacity-90';
}
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col lg:flex-row items-start gap-4">
        ...
        <div className="flex-1 min-w-0 w-full rounded-2xl border border-zinc-200 dark:border-[var(--border)] bg-zinc-50/60 dark:bg-[#0d1117] p-4 sm:p-5 shadow-xs">
          <div ref={scrollContainerRef} className="w-full overflow-x-auto pb-1 [scrollbar-width:thin]">
            <div className="w-[722px] select-none">
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <div className="relative w-[686px] h-3.5 text-[11px] text-zinc-600 dark:text-zinc-400 font-medium leading-none">
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="grid grid-rows-7 gap-[3px] h-[88px] w-7 shrink-0 text-[10px] text-zinc-600 dark:text-zinc-400 font-medium leading-none">
                       ...
                       return (
                        <button
                          ...
                          className={`w-[10px] h-[10px] rounded-[2.5px] transition-transform ${
                            ...
                            day.isToday ? 'ring-2 ring-emerald-500 ring-offset-1 dark:ring-offset-[#0d1117] z-10' : ''
          ...
          <div className="mt-3 flex items-center justify-between text-xs text-zinc-600 dark:text-zinc-400 pt-2 border-t border-zinc-200/70 dark:border-zinc-800">
            <div className="text-[11px]">
              {activeDay ? (
                ...
                <span className="hover:text-emerald-600 dark:hover:text-emerald-400 cursor-pointer transition-colors font-medium">
            ...
            {/* Less / More Legend */}
            <div className="flex items-center gap-1.5 text-[11px] select-none font-medium">
              <span>Less</span>
              <span className="w-[10px] h-[10px] rounded-[2.5px] bg-[#ebedf0] dark:bg-[#161b22] border border-black/15 dark:border-white/10" />
              <span className="w-[10px] h-[10px] rounded-[2.5px] bg-[#9be9a8] dark:bg-[#0e4429] border border-[#7bc96f] dark:border-[#006d32]" />
              <span className="w-[10px] h-[10px] rounded-[2.5px] bg-[#40c463] dark:bg-[#006d32] border border-[#30a14e] dark:border-[#26a641]" />
              <span className="w-[10px] h-[10px] rounded-[2.5px] bg-[#30a14e] dark:bg-[#26a641] border border-[#216e39] dark:border-[#39d353]" />
              <span className="w-[10px] h-[10px] rounded-[2.5px] bg-[#216e39] dark:bg-[#39d353] border border-[#195229] dark:border-[#56e36d]" />
              <span>More</span>
            </div>
          </div>
        </div>
